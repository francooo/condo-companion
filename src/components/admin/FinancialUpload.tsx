...
const FinancialUpload = () => {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast.success(`${records.length} registros financeiros importados!`);
    } catch (err: any) {
      console.error(err);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Importe um arquivo CSV com as colunas: Data, Categoria, Descrição, Valor, Tipo (receita/despesa).
        </CardDescription>
      </CardHeader>
